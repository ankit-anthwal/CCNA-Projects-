...
# Documentation & Files
- /Hotel Management System :Contains the visual network diagram (Cisco Packet Tracer file) and Technical Implementation
- /Config files :Includes configuration snippets for Routers,Switches and VLANs.
